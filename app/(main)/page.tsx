...
const FALLBACK_PRODUCTS: Product[] = [
  {
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 10, created_at: '',
  },
  {
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 20, created_at: '',
  },
  {
    id: 'materials-autumn',
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 30, created_at: '',
  },
  {
    id: 'songs-new-year',
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 40, created_at: '',
  },
  {
    id: 'scenario-8march',
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 50, created_at: '',
  },
  {
    id: 'materials-speech',
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 60, created_at: '',
  },
  {
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 70, created_at: '',
  },
  {
    id: 'songs-lullabies',
    ...
    storage_paths: [], demo_url: null, boosty_url: null, lava_url: null, recommended_product_ids: [], is_active: true, sort_order: 80, created_at: '',
  },
];
