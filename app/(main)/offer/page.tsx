    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px 80px' }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: 'var(--ink-soft)', lineHeight: 1.7 }}>
          Настоящая публичная оферта является официальным предложением ИП [Фамилия Имя Отчество],
          ИНН [номер], ОГРНИП [номер] (далее — «Продавец») заключить договор купли-продажи
